  ...
  return (
    <header className="container mx-auto md:flex justify-between py-2 max-width">
      ...
      <nav className={` ${!isOpen ? "hidden" : null} text-center md:flex justify-between`}>
        <ul style={{"color":"pink", "font-size":"large"}} className="dark:text-light-content font-medium md:flex items-center md:space-x-5 md:mr-10">
          ...
          <li className="pb-1 md:pb-0">
            <NavLink to="/codingplatforms" onClick={toggleClass}>
              CodingPlatforms
            </NavLink>
          </li>
          <li>
